...
def load_dataset():
    train_dataset = h5py.File('E:/VSCodeWorkSpace/dl_start/dl_homework/lesson_1/week_2/datasets/train_catvnoncat.h5', "r")
    train_set_x_orig = np.array(train_dataset["train_set_x"][:]) # your train set features
    train_set_y_orig = np.array(train_dataset["train_set_y"][:]) # your train set labels
    test_dataset = h5py.File('E:/VSCodeWorkSpace/dl_start/dl_homework/lesson_1/week_2/datasets/test_catvnoncat.h5', "r")
